...
class LexSubEvaluation(Task):
    def __init__(
        ...
        # self.similarity_path_save = '/home/users/u7064900/subs/LexSubGen/checkpoint/similarity_new_bert/'
        ...
        # for gloss sentence similarity score and validation score
        max_seq_length_gloss = 256
        do_lower_case = False
        # gloss_checkpoint = '/home/users/u7064900/subs/LexSubGen/checkpoint/gloss_bert/'
        max_seq_length = 128
        self.finding_gloss = CGLOSS("bert-large-uncased", max_seq_length_gloss, do_lower_case)
    ...
    def get_gloss_sim_Scores(self, tokens_lists, target_ids, proposed_words_list, given_words):
        ...
        for i in range(len(tokens)):
            ...
            if len(gloss_list) == 0:
                ...
                for word in proposed_words:
                    # proposed_words[word] = proposed_words[word] + self.delta * 0

                    score_list.append(self.delta * 0)
    ...
    def combine_xlnet_sent_scores(self, substitues, prob_values, sent_similarity_values, validation_similarities,
                                  gloss_similarities):
        final_list = []
    ...
    def get_metrics(self, dataset: pd.DataFrame) -> Dict[str, Any]:
        ...
        for (
            ...
            pred_substitutes = self.combine_xlnet_sent_scores(pred_substitutes, prob_values, text_similarities, validation_similarities, gloss_similarities)
            ...
            cadidate_validation_similarities = self.get_validation_score(tokens_lists, target_ids, candidates,
                                                                         given_words)
            cadidate_gloss_similarities = self.get_gloss_sim_Scores(tokens_lists, target_ids, candidates, given_words)

            ranked = self.substitute_generator.candidates_from_probs_fitness_gloss(
...
if __name__ == "__main__":
    ...
    if coinco:
        DEFAULT_RUN_DIR = r'C:\Users\admin-u7064900\Desktop\subs_gen\CILex\results\cilex3\coinco'
        ...
        DEFAULT_RUN_DIR = r'C:\Users\admin-u7064900\Desktop\subs_gen\CILex\results\cilex3\semeval'
        sub_generator = SubstituteGenerator.from_config("xlnet_embs.jsonnet")
