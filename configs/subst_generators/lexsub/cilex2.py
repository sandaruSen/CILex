    ...
    def get_metrics(self, dataset: pd.DataFrame) -> Dict[str, Any]:
        ...
        for (
            ...
            cadidate_validation_similarities = self.get_validation_score(tokens_lists, target_ids, candidates,
                                                                         given_words)
            cadidate_gloss_similarities = self.get_wordnet_score(tokens_lists, target_ids, candidates, given_words)
...
if __name__ == "__main__":
    ...
    if coinco:
        DEFAULT_RUN_DIR = r'C:\Users\admin-u7064900\Desktop\subs_gen\CILex\results\cilex2\coinco'
        sub_path = 'xlnet_embs.jsonnet'
        dataset_path = '../dataset/coinco.jsonnet'
        ...
        DEFAULT_RUN_DIR = r'C:\Users\admin-u7064900\Desktop\subs_gen\CILex\results\cilex2\semeval'
        sub_path = 'xlnet_embs.jsonnet'
        dataset_path = '../dataset/semeval_all.jsonnet'
