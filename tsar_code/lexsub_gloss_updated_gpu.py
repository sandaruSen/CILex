...
class LexSubEvaluation(Task):
    ...
    def get_gloss_sim_updated(self, tokens_lists, target_ids, proposed_words_list, given_words):
    ...
    def get_metrics(self, dataset: pd.DataFrame) -> Dict[str, Any]:
        ...
        for (
            ...
            if self.sent_score:
                ...
                gloss_similarities = self.get_gloss_sim_updated(tokens_lists, target_ids, pred_substitutes, given_words)
            ...
            if self.sent_score:
                ...
                cadidate_gloss_similarities = self.get_gloss_sim_updated(tokens_lists, target_ids, candidates,
                                                                        given_words)
            # ------------------------------
            ...
            ranked = self.substitute_generator.candidates_for_ablation(
                ...
                cadidate_gloss_similarities, self.sent_score, self.fitness_score, self.gloss_score_updated
            )
...
if __name__ == "__main__":
    ...
    if coinco:
        DEFAULT_RUN_DIR = r'../subs/LexSubGen/configs/subst_generators/coinco_gloss_updated/'
        sub_path = '../subs/LexSubGen/configs/subst_generators/lexsub/xlnet_embs.jsonnet'
        dataset_path = '../subs/LexSubGen/configs/subst_generators/dataset/coinco.jsonnet'
        ...
        DEFAULT_RUN_DIR = r'../subs/LexSubGen/configs/subst_generators/semeval_gloss_updated/'
        sub_path = '../subs/LexSubGen/configs/subst_generators/lexsub/xlnet_embs.jsonnet'
        dataset_path = '../subs/LexSubGen/configs/subst_generators/dataset/semeval_all.jsonnet'
